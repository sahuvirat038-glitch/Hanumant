...
class Payment(Base):
    ...
    ammount: Mapped[Numeric] = mapped_column(Numeric(10, 2), default=0, nullable=False)
    ...
    payment_date: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=func.now())
